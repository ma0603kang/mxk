...
public class JedisUtil {  
    ...
    static {    
           ...
           PropertyPlaceholder propertyPlaceholder = (PropertyPlaceholder)SpringHelper.getApplicationContext().getBean("propertyConfigurer1");
           String host = (String)propertyPlaceholder.getProperty("redis.host");
          
           Object port = (Object)propertyPlaceholder.getProperty("redis.port");
           //控制一个pool可分配多少个jedis实例，通过pool.getResource()来获取；    
           //如果赋值为-1，则表示不限制；如果pool已经分配了maxActive个jedis实例，则此时pool的状态为exhausted(耗尽)。
           config.setMaxTotal(Integer.parseInt((String) propertyPlaceholder.getProperty("redis.maxTotal")));
           config.setMaxIdle(Integer.parseInt((String) propertyPlaceholder.getProperty("redis.maxIdle")));
           config.setMinIdle(Integer.parseInt((String) propertyPlaceholder.getProperty("redis.minIdle")));//设置最小空闲数
           config.setMaxWaitMillis(Integer.parseInt((String) propertyPlaceholder.getProperty("redis.maxWait")));
        ...
        //   config.setMaxIdle(50);    
         ...
         //  config.setMaxWaitMillis(1000 * 100);    
           ...
           String password = (String)propertyPlaceholder.getProperty("redis.password");
          jedisPool = new JedisPool(config, host.toString(),(int)port);   
      }  
   ...
   public static void main(String[] args) throws Exception {  
	   ...
	   Map<String, List<Map<Object, Object>>> mapList = new HashMap<String, List<Map<Object, Object>>>();
		Jedis jedis = JedisUtil.getInstance().getJedis();
		Set<String> keys = jedis.keys("*");
		Iterator<String> iterator = keys.iterator();
		while (iterator.hasNext()) {
			String key = iterator.next();//获取redis的key
			String str = jedis.get(key);
			List<Map<Object,Object>> getJsonListByString = GetJsonListByString(str);
			mapList.put(key, getJsonListByString);
		}
   ...
   /**
	 * 将String转为list Map
	        ...
	        * @Description:
	 */
	public static List<Map<Object, Object>> GetJsonListByString(String jsonFile) throws Exception
   {
